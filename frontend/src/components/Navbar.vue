        ...
        <v-toolbar>
            ...
            <v-toolbar-items>
                <div class="link" v-for="(link, index) in links" :key="index">
                    <v-btn v-if="!link.dropdown" text router :to="link.destination" exact>{{ link.title }}</v-btn>
                    <v-menu v-else offset-y>
                        ...
                        <v-list>
                            <v-list-item v-for="(sublink, index) in link.sublinks" :key="index" router :to="sublink.destination">
