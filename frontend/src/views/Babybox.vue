  ...
  methods: {
    ...
    findStats: function() {
      ...
      if(this.stats.count > 0) {
        ...
        this.stats.status.quality = (this.stats.status.quality * 100 / this.stats.count).toFixed(2);
        if(this.stats.count < 100) {
          this.stats.status.quality100 = (this.stats.status.quality100 * 100 / this.stats.count).toFixed(2);
        }
      }
      this.formatStats()
    },
    formatStats: function() {
      this.statsFormatted = [
        ...
        { icon: "mdi-percent", text: "Kvalita", value: this.stats.count, unit: "%" },
        { icon: "mdi-percent", text: "Kvalita / 100", value: this.stats.count, unit: "%" },
